namespace Jpl.MicroService.Host.Configurations;
...
internal static class Startup
{
    internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
    {
        ...
        builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/rsapiurl.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/eventbus.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/applicationinsight.json", optional: false, reloadOnChange: true)
