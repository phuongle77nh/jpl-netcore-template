...
using Jpl.MicroService.Application.Common.FileStorage;
using Jpl.MicroService.Domain.Common;
using Jpl.MicroService.Infrastructure.Common.Extensions;

namespace Jpl.MicroService.Infrastructure.FileStorage;
