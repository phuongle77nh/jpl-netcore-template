...
public class EventBusRabbitMQ : IEventBus, IDisposable
{
    ...
    public EventBusRabbitMQ(IRabbitMQPersistentConnection persistentConnection, ILogger<EventBusRabbitMQ> logger,
        IServiceProvider serviceProvider, IEventBusSubscriptionsManager subsManager, string brokerName, string queueName = null, int retryCount = 5)
    {
    ...
    public void Publish(IntegrationEvent @event)
    {
        ...
        byte[] body = JsonSerializer.SerializeToUtf8Bytes(@event, @event.GetType(), s_indentedOptions);
        ...
        if (_subsManager.HasSubscriptionsForEvent(eventName))
        {
            ...
            foreach (var subscription in subscriptions)
            {
                ...
                else
                {
                    ...
                    object? integrationEvent = JsonSerializer.Deserialize(message, eventType, s_caseInsensitiveOptions);
